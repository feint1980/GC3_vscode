...
Skill_Table["ManaShield"] = S_Skill:new({
    ...
    description = "Fragile, but sustained by a reservoir of magic. Patchouli shrouds \nherself in layered elemental wards, allowing mana to bear the pain her body \ncannot. What would fell another becomes a mere fluctuation in her energy flow.",
    effectTxt = "Absorbs " .. Tag.color_TB_WIS .. "80% " .. Tag.color_close .. "of incoming damage, converting it into mana loss instead of \nHP loss. If her mana is depleted, the shield fails and she begins to take full \ndamage.",
