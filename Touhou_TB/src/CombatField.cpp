...
void CombatField::init(const std::string & scriptPath, lua_State * script)
{
    ...
    m_bg.init(Feintgine::ResourceManager::getTexture("./Assets/Textures/Palace_of_the_Earth_Spirits.png"),glm::vec2(0,250), glm::vec2(1280, 720) * 1.1f,Feintgine::Color(255, 255, 255, 255));
