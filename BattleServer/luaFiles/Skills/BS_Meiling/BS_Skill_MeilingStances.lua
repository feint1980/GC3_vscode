...
function BS_Skill_MeilingStances:create(character)
    ...
    o.isPassive = true
    o.description = "Meiling can switch between 3 stances each stance grant difference buffs:\n\
    > Liang Yi Zhuang: grant +5% physic attack, +5% physic def\n\
    > Pu Bu: grant -40% physic attack, +25% physic def\n\
    > Du Li Bu: grant +20% physic attack, -40% physic def"
    o.costText = "Passive"
