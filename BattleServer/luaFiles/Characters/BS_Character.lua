...
function BS_Character:init(userID, characterID, statsStr)
...
---@param userID string
---@param characterID string
function BS_Character:getCharacterByUserID_CharacterID(userID, characterID)
...
---@param str number
function BS_Character:setStrength(str)
    self.Strength = str
...
---@param vit number
function BS_Character:setVitality(vit)
    self.Vitality = vit
...
---@param dex number
function BS_Character:setDexterity(dex)
    self.Dexterity = dex
...
---@param agi number
function BS_Character:setAgility(agi)
    self.Agility = agi
...
---@param int number
function BS_Character:setIntelligence(int)
...
---@param wis number 
function BS_Character:setWisdom(wis)
    self.Wisdom = wis
...
---@param action number
function BS_Character:setAction(action)
    self.action = action
...
-- ---@param hp number
-- function BS_Character:setHP(hp)
--     self.hp = hp
...
-- ---@param mana number
-- function BS_Character:setMana(mana)
--     self.mana = mana
...
-- ---@param sp number
-- function BS_Character:setSP(sp)
--     self.sp = sp
