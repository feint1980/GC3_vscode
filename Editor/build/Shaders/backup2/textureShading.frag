	  		...
	  		//cos(angle) * (position.y - pos1.y) <= sin(angle) * (position.x - pos1.x) + 0.001 )   
     			 ...
     			 if((mod(rayRotation[i],6.28318530718f) >= 0.0f && 
     				...
     				// {
	     				...
	     				if(    sin(rayRotation[i]  + 1.57079632679f) * ( fragmentPosition.y - rayLightPos[i].y)  >= cos(rayRotation[i]  + 1.57079632679f) * (fragmentPosition.x - rayLightPos[i].x) - radius
	 						&& sin(rayRotation[i]  + 1.57079632679f) * ( fragmentPosition.y - rayLightPos[i].y)  <= cos(rayRotation[i]  + 1.57079632679f) * (fragmentPosition.x - rayLightPos[i].x) + radius)
