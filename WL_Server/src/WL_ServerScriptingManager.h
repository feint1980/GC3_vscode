#ifndef WL_ServerScriptingManager_H
#define WL_ServerScriptingManager_H
...
class WL_ServerScriptingManager
{
public:
    PacketCode getSpecialRequestCode(RakNet::Packet *p);

    WL_ServerScriptingManager();
    ~WL_ServerScriptingManager();
...
#endif // WL_ServerScriptingManager_H