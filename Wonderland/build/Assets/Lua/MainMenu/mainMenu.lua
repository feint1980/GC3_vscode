...
package.path = package.path .. ';./Assets/Lua/system/GUI/?/?.lua;' .. ';./Assets/Lua/system/GUI/widgets/?.lua;' .. ';./Assets/Lua/system/Networking/?.lua;' .. ';./Assets/Lua/MainMenu/?.lua;' .. ';./Assets/Lua/system/event/?.lua;'
...
function LoginSceneInit(host,TGUIScriptingPtr,ClientScriptingPtr)
    ...
    tosText:init(Login_GUIScriptingPtr,"This is just a beta prototype" ,0,TGUI_ScreenHeight/2,tosPanel.ptr)
    tosText:setAlignment(TextAlginment.Center)
    tosText:setPosStr("50%","15%")

    local tosAgree = Label:new()
    tosAgree:init(Login_GUIScriptingPtr,"OK",0,0,tosPanel.ptr)
